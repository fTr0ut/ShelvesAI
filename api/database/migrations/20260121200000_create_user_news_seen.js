...
exports.up = async function (knex) {
    await knex.schema.createTable('user_news_seen', (table) => {
...
exports.down = async function (knex) {
    await knex.raw(`DROP INDEX IF EXISTS idx_user_news_seen_user;`);
    await knex.schema.dropTableIfExists('user_news_seen');
};
