...
import Label from "../../Label"; // plasmic-import: ey4bWtUegirG/component
import TextInput from "../../TextInput"; // plasmic-import: Hk81OJgG4RRf/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: c-g7tltfHmic/component
import Description from "../../Description"; // plasmic-import: 2a5VvGAzIWzR/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: 2c-eRmr-SVf0/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox___1HoC2, {
          [sty.freeBoxiconEnd___1HoC2LN85H]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart___1HoC2AaNo]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine___1HoC2TNvrm]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__f9OOt, {
            [sty.freeBoxiconStart__f9OOtAaNo]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__f9OOTtNvrm]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__c0Wjv)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__yo8C, {
            [sty.freeBoxiconEnd__yo8CLN85H]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__yo8CAaNo]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg___4DtkN)}
                role={"img"}
              />
            ),
